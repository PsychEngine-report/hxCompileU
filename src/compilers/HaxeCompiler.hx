...
class HaxeCompiler {
	...
	public static function init():Void {
		...
		try {
			var workspace = Sys.getEnv("GITHUB_WORKSPACE");
			var basePath = (workspace != null && workspace != "") ? workspace : Sys.getCwd();
			if (!StringTools.endsWith(basePath, "/") && !StringTools.endsWith(basePath, "\\")) {
				basePath += "/";
			}
